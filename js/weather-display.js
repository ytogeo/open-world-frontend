    ...
    layui.use(function () {
        ...
        snowSizeSlider = slider.render({
            ...
            change: function (value) {
                ...
                let snowSpeed = (-snowSpeedSlider.config.value + 200).toFixed(1);
        ...
        snowSpeedSlider = slider.render({
            ...
            change: function (value) {
                //根据滑块获取雪花大小和速度
                let snowSize = (snowSizeSlider.config.value / 1000).toFixed(3);
    ...
    layui.use(function () {
        ...
        rainSizeSlider = slider.render({
            ...
            change: function (value) {
                ...
                let rainSpeed = (-rainSpeedSlider.config.value + 200).toFixed(1);
                let rainAngle = rainAngleSlider.config.value / 10.0;
        ...
        rainSpeedSlider = slider.render({
            ...
            change: function (value) {
                //根据滑块获取参数
                let rainSize = (rainSizeSlider.config.value / 100).toFixed(3);
...
function myCreateRain(rainSize, rainSpeed, rainAngle) {
    ...
    //GLSL代码，自定义下雨效果
    let rainEffect = "uniform sampler2D colorTexture;\n\
    ...
    ";
    //将新的降雨效果添加到场景中
    let newRainStage = viewer.scene.postProcessStages.add(new Cesium.PostProcessStage({
...
function myCreateFog(fogVisibility) {
    ...
    let fogEffect = "uniform sampler2D colorTexture;\n\
    ...
    { \n\
       ...
       gl_FragColor = mix(origcolor,vec4(" + fogColor.red + "," + fogColor.green + "," + fogColor.blue + "," + fogColor.alpha + "), f); \n\
    }\n";
    //将新的雾天效果添加到场景中
    let newFogStage = viewer.scene.postProcessStages.add(new Cesium.PostProcessStage({
